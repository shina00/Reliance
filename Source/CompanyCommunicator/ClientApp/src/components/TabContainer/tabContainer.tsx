...
import message from '../image/message.png'; // with import
    ...
    public render(): JSX.Element {
        ...
        return (
            <Flex className="tabContainer" column fill gap="gap.small">
                <Flex className="newPostBtn" hAlign="center" vAlign="center">
                <img src={message} /> 
                    <Button content={this.localize("NewMessage")} onClick={this.onNewMessage} style={{backgroundColor:"#088F8F",borderRadius:"30px"}} primary />
                </Flex>
